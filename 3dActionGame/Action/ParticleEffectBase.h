...
public:
	...
	*/
	ParticleEffectBase(const Vector3& _pos, const Vector3& _velocity, const int& _lifeCount, const std::string& _spriteFileName, const Tag& _objectTag, SceneBase::Scene _sceneTag, const float& _scale = 10);
	~ParticleEffectBase();
