#include "PlayerObjectStateDrawnSword.h"
...
PlayerObjectStateDrawnSword::PlayerObjectStateDrawnSword(bool _moveFlag)
	: mIsIdle(false)
	, mIsRunStart(false)
	, mIsAttack(false)
	, moveFlag(false)
...
PlayerObjectStateDrawnSword::~PlayerObjectStateDrawnSword()
{
	printf("Remove : [PlayerObjectStateBase] PlayerObjectStateDrawnSword\n");
}

PlayerState PlayerObjectStateDrawnSword::Update(PlayerObject* _owner, float _deltaTime)
{
...
void PlayerObjectStateDrawnSword::Inipt(PlayerObject* _owner, const InputState& _keyState)
{
...
// RUN状態への切り替え処理
void PlayerObjectStateDrawnSword::Enter(PlayerObject* _owner, float _deltaTime)
{
	if (moveFlag)
	{
...
void PlayerObjectStateDrawnSword::MoveCalc(PlayerObject* _owner, float _deltaTime)
{
	/*if (buttonFlag == false)
	{
		charaSpeed -= 1.0f;
