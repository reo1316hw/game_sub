...
PlayerObjectStateSecondAttack::PlayerObjectStateSecondAttack()
	...
	, mSecondAttackEffectPtr(nullptr)
{
}
...
PlayerState PlayerObjectStateSecondAttack::Update(PlayerObject* _owner, const float _DeltaTime)
{
	...
	Vector3 faceInFlockCenterVec = mSecondAttackEffectPtr->GetFaceInFlockCenterVec();
...
bool PlayerObjectStateSecondAttack::ReceivedAttack(const Tag& _hitTag, const int& _DamageValuePlayerAttack)
{
	if (mHitTag == _hitTag)
	{
...
bool PlayerObjectStateSecondAttack::VerticalKeyInputOperation(const InputState& _KeyState, const SDL_Scancode& _KeyScancode, const SDL_GameControllerButton& _ButtonScancode,
...
/// <returns> true : 何か押した, false : 何も押さなかった </returns>
bool PlayerObjectStateSecondAttack::LateralKeyInputOperation(const InputState& _KeyState, const SDL_Scancode& _KeyScancode,
...
bool PlayerObjectStateSecondAttack::LeftStickDefeatLeftInputOperation(const float& _AngleBorderMin, const float& _AngleBorderMax, const float& _ValueShortenVector)
{
	if (mLeftAxis.x < 0.0f)
	{
		RotateInRangeAngle(_AngleBorderMin, _AngleBorderMax, _ValueShortenVector);
...
/// <returns> true : スティックを倒した, false : スティックを倒さなかった </returns>
bool PlayerObjectStateSecondAttack::LeftStickDefeatRightInputOperation(const float& _AngleBorderMin, const float& _AngleBorderMax, const float& _ValueShortenVector)
{
	if (mLeftAxis.x > 0.0f)
	{
		RotateInRangeAngle(_AngleBorderMin, _AngleBorderMax, _ValueShortenVector);
...
/// <param name="_AngleBorderMax"> 境目の角度の最大値 </param>
/// <param name="_ValueShortenVector"> ベクトルを短くする値 </param>
void PlayerObjectStateSecondAttack::RotateInRangeAngle(const float& _AngleBorderMin, const float& _AngleBorderMax, const float& _ValueShortenVector)
{
